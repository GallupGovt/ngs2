...
exp2_cooperation <- read.csv(url("https://raw.githubusercontent.com/gallup/NGS2/master/cooperation_exp2_FINAL.csv"),
                             header = TRUE,
                             sep = ',')

exp2_rewire <- read.csv(url("https://raw.githubusercontent.com/gallup/NGS2/master/rewire_exp2_FINAL.csv"),
                        header = TRUE,
                        sep = ',')
