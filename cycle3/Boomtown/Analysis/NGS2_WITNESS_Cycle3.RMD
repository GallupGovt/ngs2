...
summary(fittedGlmer, digits = 2))
```
- Prediction 1: Prospect value, calculated according to Cumulative Prospect Theory, will determine Individual Motivation to Innovate (T1) 
- Prediction 2: Prospect value, calculated according to Expected Utility Theory, will determine Individual Motivation to Innovate (T1) 
- Prediction 3: Prospect value, calculated according to Probability Theory, will determine Individual Motivation to Innovate (T1) 
- Prediction 4: Prospect value, calculated according to a combination of CPT + Summative Expectancy Theory, will determine Individual Motivation to Innovate (T1) 
