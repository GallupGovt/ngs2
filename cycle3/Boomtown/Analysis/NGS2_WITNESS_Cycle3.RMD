...
library ("pacman")
pacman::p_load(rstan, rstanarm, ggplot2, Hmisc, httr, bridgesampling, DT, dplyr, bayesplot, knitr, lme4, RCurl, formatR, caret, pROC, formatR, foreach, doParallel, forcats, tidyr, car, statnet)
...
setup <- c("functions.R", "analytics.R", "density.R", "survey_analytics.R", "survey_tests_cycle_3_code.R")
