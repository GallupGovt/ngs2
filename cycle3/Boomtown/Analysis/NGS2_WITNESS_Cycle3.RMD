...
nChains <- 3 # Number of MCMC chains, drives processing time.
nIter <- 10000 # MCMC sampling iterations, drives processing time.
# load libraries
if (!require("pacman")) install.packages("pacman")
library ("pacman")
pacman::p_load(rstan, rstanarm, gplots, ggplot2, Hmisc, httr, bridgesampling, DT, dplyr, bayesplot, knitr, lme4, 
RCurl, formatR, car, caret, pROC, formatR, foreach, doParallel, tidyr, forcats)
