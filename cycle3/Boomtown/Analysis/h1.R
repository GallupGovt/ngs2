...
# Formula
formula.h1<-as.formula("inmot1~competition+tools+tolerance+support+centralization+leaderWeight+pressure+framing+density+timeUncertainty+(1|player)+(1|group)") #Formula h1.null
