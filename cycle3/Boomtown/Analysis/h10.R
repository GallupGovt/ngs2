...
# Formula
formula.h11<-as.formula("inmot1~framing*risk+prb+timeUncertainty+pressure+tolerance+competition+support+centralization+leaderWeight+density+(1|player)+(1|group)")
