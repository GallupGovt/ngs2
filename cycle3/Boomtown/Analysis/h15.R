...
fittedGlmer <- stan_glmer(formula.h15.1, data=factorial, family=gaussian(link = "identity"), iter=3, chains=1)
...
bridge_15.0 <- bayesLmer(formula.h15.1, h15.0, factorial)
bridge_15.1 <- bayesLmer(formula.h15.1, h15.1, factorial)
