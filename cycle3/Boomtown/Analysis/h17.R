...
# Formula
formula.h17<-as.formula("inmot2~support+framing+complexity+timeUncertainty+pressure+tolerance+competition+centralization+leaderWeight+density+(1|player)+(1|group)")
