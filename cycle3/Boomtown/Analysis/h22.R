...
# Formula
formula.h22<-as.formula("inmot2~inmot1+centralization+density+conformity+grmot1+support+framing+complexity+timeUncertainty+pressure+tolerance+competition+leaderWeight+(1|player)+(1|group)")
