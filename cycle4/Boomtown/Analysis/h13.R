...
fittedGlmer <- suppressWarnings(stan_glmer(formula.h13.1, data=factorialGroup, family=gaussian(link = "identity"), iter=3, chains=1, refresh=0))
...
rmarkdown::render("NGS2_WITNESS_Cycle4_h13.rmd")
