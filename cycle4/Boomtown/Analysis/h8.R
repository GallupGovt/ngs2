...
fittedGlmer <- suppressWarnings(stan_glmer(formula.h8, data=factorial, family=binomial(link="logit"), iter=3, chains=1, refresh=0))
...
rmarkdown::render("NGS2_WITNESS_Cycle4_h8.rmd")
